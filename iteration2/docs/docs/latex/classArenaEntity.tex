...
\begin{DoxyCompactList}\small\item\em handle collisons for both the \hyperlink{classLight}{Light} and the robot, Each using it in a away appropiate to that mobile entity \end{DoxyCompactList}\item 
...
handle collisons for both the \hyperlink{classLight}{Light} and the robot, Each using it in a away appropiate to that mobile entity 
...
\item 
/home/musex025/\+Desktop/project-\/musex025/iteration2/src/\hyperlink{arena__entity_8h}{arena\+\_\+entity.\+h}\end{DoxyCompactItemize}
